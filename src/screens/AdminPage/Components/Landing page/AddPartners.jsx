...
import { CreatePartnersLogo } from "../../../../Services/Admin-Service";
...
const AddPartners = () => {
  ...
  const AddPartners = async () => {
    ...
    CreatePartnersLogo({ data: product }).then(() =>
      window.open("/@dm!n?NewPartner=true", "_self")
    );
  };
  ...
  useEffect(() => {
    if (data.companyName && !error) AddPartners();
  }, [error]);
