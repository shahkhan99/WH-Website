...
const EditCommunity = ({ editData }) => {
    ...
    const [data, setData] = useState(editData ? { memberName:editData.memberName, companyName:editData.companyName, images:editData.images } : {});
    ...
    const AddNewCommunity = async () => {
        ...
        UpdateCommunity({ id:editData.id, data:product }).then(() => window.open('/@dm!n?NewCommunity=true', '_self'))
    }
        ...
        <div>
            ...
            :
                <div className={classes.wrapper}>
                    ...
                    <Input id='memberName' label='Member Name' value={data.memberName} placeholder='Member Name' handleChange={onChange}/>
                    ...
                    <Input id='companyName' label='Company Name' value={data.companyName} placeholder='Company Name' handleChange={onChange}/>
