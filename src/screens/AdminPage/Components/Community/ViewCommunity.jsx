...
import { GetAllCommunity, DeleteOneCommunity } from '../../../../Services/Admin-Service';
    ...
    render () {
        ...
        return (
            <div style={{padding:'50px'}}>
                ...
                {details && <CommunityDetails data={products[index]} onEdit={this.onClickEdit} /> }
                {edit && <EditCommunity editData={products[index]} /> }
