...
export default function EnhancedTable({ data, loading, onDetails, onDelete }) {
    ...
    const columns = [
        { title: 'Name', field: 'short_name', render: rowData => <Typography variant='subtitle2'>{rowData.short_name}</Typography> },
        ...
        { title: 'Price', field: 'price', render: rowData => <Typography variant='subtitle2'>{rowData.price}</Typography> },
