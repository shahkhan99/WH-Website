...
import { GetAllProducts, DeleteOneProduct } from '../../../../Services/Admin-Service';
    ...
    render () {
        ...
        return (
            <div style={{padding:'50px'}}>
                ...
                {details && <ProductDetails data={products[index]} onEdit={this.onClickEdit} /> }
                {edit && <EditProduct editData={products[index]} /> }
